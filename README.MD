...
Demo showcasing the usage of normal maps (texture that defines the surface direction for every pixel) on a Sega Megadrive. It shows a checkered torus with a double-sided directional light spinning randomly around it.
...
If you want to see how the resources are loaded, check function **OnEnterLoadingMain** in [src/demo/statemachine/stateloadingmain.c](src/demo/statemachine/stateloadingmain.c)
...
The color palette in the resulting image(s) is not relevant for the lighting algorithm, but for debugging purposes they should convey the encoded properties.
...
* A custom conversion tool called [MDNormalMapEncoder](https://github.com/Someguy-code/MDNormalMapEncoder.git)

## Special thanks
I'd like to thank the following people for making this project possible
* Stephane Dallongeville for the creation of [SGDK](https://github.com/Stephane-D/SGDK)
